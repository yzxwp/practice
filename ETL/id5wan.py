...
if __name__ == '__main__':
    ttime = 1603166400000
    n = 86400000
    for i in range(10000, 2010001):
        s = string.ascii_letters
        idcard_name = random.choice(s) + random.choice(s) + random.choice(s) + random.choice(s)
        idcard_no = main()
        j=n * (i // 50000)
        print(str(i) + ';' + ';' + idcard_name + ';' + idcard_no + ';' + '00123456789;P100' + str(i) + ';0;;' + str(
                    ttime +j ))
        date=(str(i) + ';' + ';' + idcard_name + ';' + idcard_no + ';' + '00123456789;P100' + str(i) + ';0;;' + str(
                    ttime +j ))
        with open('E:/200wanID.txt', 'a') as file_handle:  # .txt可以不自己新建,代码会自动新建
            file_handle.write(date)  # 写入
