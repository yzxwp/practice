    ...
    for i in range(1, 20):
        ...
        for j in range(0, (i * 50001 - (i - 1) * 50001)):
            if count < 40000:
                ...
                count = count + 1
                data = uid.getUUID() + ";" + "f2eb6b4a34b3fb" + str(count) + "dbddd;01;0;" + name.random_name() + "|1|" + idcard.main() + "|" + phone.phone_num() + "|H1003029419|2020年06月16日|2686.68|null|null|null|null|null;;1;;;;"+ str(t + tt * i)
